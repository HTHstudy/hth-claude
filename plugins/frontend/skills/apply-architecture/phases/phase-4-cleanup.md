...
파일 rename 및 import 수정은 [Phase 1의 일괄 처리 전략](phase-1-structure.md#일괄-처리-전략)을 동일하게 적용한다 (매핑 테이블 → 셸 스크립트 일괄 `git mv`, macOS 대소문자 FS 2단계 rename, import 일괄 치환 후 Grep 도구로 잔여 검증).
