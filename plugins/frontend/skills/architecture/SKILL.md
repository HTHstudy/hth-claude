---
name: architecture
description: 프론트엔드 레이어드 아키텍처 규칙. 프론트엔드 코드를 작성, 리뷰, 리팩토링할 때 자동 적용한다. 레이어 구조(app/pages/shared), import 방향, 네이밍 컨벤션, Slice 분해·추출 원칙을 강제한다. tsx, jsx, css, hook, component, page, shared, entity, feature, widget 파일을 다룰 때 반드시 이 규칙을 따른다.
---
...
**필수 설정:**
- [ ] tsconfig path alias — `@app/*`, `@pages/*`, `@shared/*`, `@widgets/*`, `@features/*`, `@entities/*`
